        ...
        <UserProvider>
          <Routes>
            <Route path="/customermainlayout" element={<CustomerMainLayout />}>
              ...
              <Route
                path="/customermainlayout/dashboard"
                element={<CustomerDashboard />}
              />
              <Route
                path="/customermainlayout/shop/:shop_name/:branch/:ShopCode"
                element={<CustomerViewShop />}
              />
              <Route
                path="/customermainlayout/categories"
                element={<CustomerCategories />}
              />
              <Route
                path="/customermainlayout/orders"
                element={<CustomerOrders />}
              />
              <Route
                path="/customermainlayout/jobs"
                element={<CustomerJobTabView />}
              />
              <Route path="/customermainlayout/cart" element={<CartPage />} />
              <Route
                path="/customermainlayout/profile"
            ...
            >
              ...
              <Route
                ...
                element={<PayemntIntegration />}
              />
              <Route
                path="/deliveryscheduling"
                element={<DeliverySheduling />}
              />
              ...
              <Route
                path="/supplierinteraction"
                element={<SupplierInteraction />}
              />
              ...
              <Route
                path="/shopnotifications"
                element={<ShopNotifications />}
              />
              <Route
              ...
              ></Route>
              <Route
                path="/updateshopownerprofile/:username"
                element={<UpdateShopOwnerProfile />}
              ></Route>
            </Route>

            <Route
              path="/deliveryrider_mainlayout"
              element={
                <ProtectedRoute>
                  <DeliveryRider_MainLayout />
                </ProtectedRoute>
              }
            >
              <Route index element={<Dashboard />} />
              <Route
                path="/deliveryrider_mainlayout/deliveryrider_dashboard"
                element={<DeliveryRider_Dashboard />}
              />
              <Route
                path="/deliveryrider_mainlayout/deliveryriderprofile"
                element={<DeliveryRiderProfile />}
              />
              <Route
                path="/deliveryrider_mainlayout/updatedeliveryriderprofile"
                element={<UpdateDeliveryRiderProfile />}
              />
              <Route
                path="/deliveryrider_mainlayout/DeliveryRider_accepted_deliveries"
                element={<DeliveryRider_accepted_deliveries />}
              />
              <Route
                path="/deliveryrider_mainlayout/DeliveryRider_completed_deliveries"
                element={<DeliveryRider_completed_deliveries />}
              />
              <Route
                path="/deliveryrider_mainlayout/DeliveryRider_pending_deliveries"
                element={<DeliveryRider_pending_deliveries />}
              />
            </Route>
