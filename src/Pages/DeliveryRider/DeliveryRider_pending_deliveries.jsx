...
const DeliveryRider_pending_deliveries = () => {
  ...
  const openAcceptOrderModal = async () => {
    ...
    if (isConfirmed) {
      try {
        ...
        const response = await DeliveryService.putaccept_order(selectedDelivery, user);
      ...
      default:
        ...
        return (
          <div>
            ...
            <div>
              <button onClick={openAcceptOrderModal}>Accept Order</button>
            </div>
          </div>
        );
    }
